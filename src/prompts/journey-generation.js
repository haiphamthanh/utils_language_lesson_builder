export const JOURNEY_PROMPT_VERSION = 'opencode-journey-v2';
...
Create a separate description for the whole journey: one evocative Vietnamese sentence of 12-24 words that feels like the introduction to an antique book. It must describe the journey, not instruct the learner.
...
The journey description must complement the title without repeating it.
