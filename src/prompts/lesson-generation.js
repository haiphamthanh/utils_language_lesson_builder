import { MAX_GENERATED_LESSON_WORDS } from '../domain/generated-lesson.js';

export const LESSON_PROMPT_VERSION = 'opencode-lesson-v2';
...
The lesson content has a hard maximum of ${MAX_GENERATED_LESSON_WORDS} words. Count only the content field, not the title, summary, or review.
...
Target length: 6–10 short sentences appropriate for the learner level, never exceeding ${MAX_GENERATED_LESSON_WORDS} words in the content field.
